...
import com.example.colademo.domain.metrics.techinfluence.AuthorType;
import com.example.colademo.domain.metrics.techinfluence.InfluenceMetric;
import com.example.colademo.domain.metrics.techinfluence.PatentMetric;
import com.example.colademo.domain.metrics.techinfluence.PatentMetricItem;
import com.example.colademo.domain.user.UserProfile;
import com.example.colademo.dto.PatentMetricAddCmd;
